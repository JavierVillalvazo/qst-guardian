...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.mono_font = ctk.CTkFont(family="Consolas", size=13, weight="normal")
    ...
    def create_ui(self):
        ...
        #self.header_frame.pack(fill="x", padx=5, pady=(5, 3))

        # Botones LIMPIAR y DETENER en la esquina superior izquierda
        ...
        # Espaciador para empujar el indicador de estado a la derecha
        ctk.CTkLabel(self.header_frame, text="", width=10).pack(side="left", expand=True)
        ...
        self.log_frame.pack(fill="both", expand=True, padx=5, pady=3)
        ...
        # El botón de pausar ya no se crea aquí
